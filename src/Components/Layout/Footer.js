...
import { GetReport, LastInsertedReportId } from '../../Context/Report/ReportActions';
  ...
  return (
    <footer className="footer items-center p-4 bg-neutral text-neutral-content">
      <div className="items-center grid-flow-col">
        ...
        {report !== null ? <p>Last report made {moment(report.timestamp).fromNow()} </p> : null}
      </div>
